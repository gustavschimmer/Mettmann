...
var format_Vereinfacht_2 = new ol.format.GeoJSON();
var features_Vereinfacht_2 = format_Vereinfacht_2.readFeatures(json_Vereinfacht_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vereinfacht_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vereinfacht_2.addFeatures(features_Vereinfacht_2);
var lyr_Vereinfacht_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vereinfacht_2, 
                style: style_Vereinfacht_2,
                popuplayertitle: 'Vereinfacht',
                interactive: true,
                title: '<img src="styles/legend/Vereinfacht_2.png" /> Vereinfacht'
            });

lyr_OSMStandard_0.setVisible(true);lyr_districtsvollstndig_1.setVisible(true);lyr_Vereinfacht_2.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_districtsvollstndig_1,lyr_Vereinfacht_2];
...
lyr_Vereinfacht_2.set('fieldAliases', {'fid': 'fid', 'path': 'path', 'begin': 'begin', 'end': 'end', });
...
lyr_Vereinfacht_2.set('fieldImages', {'fid': 'TextEdit', 'path': 'TextEdit', 'begin': 'DateTime', 'end': 'DateTime', });
...
lyr_Vereinfacht_2.set('fieldLabels', {'fid': 'no label', 'path': 'no label', 'begin': 'no label', 'end': 'no label', });
lyr_Vereinfacht_2.on('precompose', function(evt) {
